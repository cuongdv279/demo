    ...
    <div class="col-md-10 content">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <span class="glyphicon glyphicon-list"></span>Danh sách nhóm
            ...
            <div class="panel-body">
                <ul class="list-group">
                    <c:forEach var="listPost" items="${listPost }" varStatus="status">
                        <li class="list-group-item">
                            ...
                            <div class="pull-right action-buttons">
                                <spring:url value="/manage-user/edit-post-topic/${listPost.post_ID}" var="manageUserEditPost"/>
                                <a href="${manageUserEditPost}" data-toggle="tooltip" data-placement="left" title="Edit post" ><span class="glyphicon glyphicon-pencil"></span></a>
                                <spring:url value="/manage-user/delete-post-topic/${sessionUser.user_ID}/delete/${listPost.post_ID}" var="manageUserDeletePost"/>
                                <a href="${manageUserDeletePost}" class="trash" onclick=""data-toggle="tooltip" data-placement="top" title="Delete post "><span class="glyphicon glyphicon-trash"></span></a>
                                <spring:url value="/manage-user/list-user-join-topic/${listPost.post_ID}" var="manageUserListJoin"/>
                                <a href="${manageUserListJoin}" class="flag" data-toggle="tooltip" data-placement="bottom" title="List users join to post"><span class="glyphicon glyphicon-user"></span></a>
                            </div>
                        </li>
                    </c:forEach>
                </ul>
                        ...
                        <div class="col-lg-12 text-center jPager">
                            <div class="col-md-12">
                                <ul id="pagination" class="">
                                    ...
                                    <spring:url value="/manage-user/manage-post-topic/${sessionUser.user_ID}/page/0" var="first" />
                                    <spring:url value="/manage-user/manage-post-topic/${sessionUser.user_ID}/page/${pre}" var="page_pre" />
                                    <spring:url value="/manage-user/manage-post-topic/${sessionUser.user_ID}/page/${next}" var="page_next" />
                                    <spring:url value="/manage-user/manage-post-topic/${sessionUser.user_ID}/page/${last}" var="last" />
                                    <li id = "first" class="">
