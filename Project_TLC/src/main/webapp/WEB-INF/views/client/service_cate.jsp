                        ...
                        <div class="col-lg-12 text-center jPager">
                            <div class="col-md-6">
                                <ul id="pagination" class="">
                                    ...
                                    <li id = "first" class="">
                                        <a href="<c:url value="/post-user/post-topic/search/${cateId}/page/0" />">Đầu</a>
                                    </li>
                                    <li id = "previous" class="">
                                        <a href="<c:url value="/post-user/post-topic/search/${cateId}/page/${page_pre }" />" ><</a>
                                    </li>
                                    <c:choose>
                                        <c:when test="${total == 0}">
                                    ...
                                    <li id="next" class="">
                                        <a href="<c:url value="/post-user/post-topic/search/${cateId}/page/${page_next }" />">></a>
                                    </li>
                                    <li id = "last" class="">
                                        <a href="<c:url value="/post-user/post-topic/search/${cateId}/page/${last }" />">Cuối</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
