                ...
                <div class="panel">
                    <div class="panel-heading">
                        <div class="text-center">
                            <div class="row">
                                <div class="col-sm-9">
                                    <h3 class="pull-left">${listPostLocal.post_Name}</h3>
                                </div>
                                <div class="col-sm-3">
                                    <h4 class="pull-right">
                                        <small><em>${listPostLocal.public_Date}</em></small>
                                    </h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel-body">
                        <spring:url value="/post-event/info-post/${listPostLocal.post_ID}" var="inforpost"/>
                        <a href="${inforpost}" class="thumbnail">
                            <img alt="Image" src="${upload}imgPostLocal/${listPostLocal.image }">
                        </a>
                        ${fn:substring(listPostLocal.post_Content,0,250)}... <a href="${inforpost}">Xem thêm</a>
                    </div>
                    <div class="">
                        <span class="label"><i style="color: #3796a9" class="fa fa-eye">${listPostLocal.num_View}</i></span>
            ...
            <div class="col-lg-12 text-center jPager">
                <div class="col-md-6">
                    <ul id="pagination" class="">
                        ...
                        <spring:url value="/post-event/post/fl/categories/${cateID}/page/0" var="first" />
                        <spring:url value="/post-event/post/fl/categories/${cateID}/page/${pre}" var="page_pre" />
                        <spring:url value="/post-event/post/fl/categories/${cateID}/page/${next}" var="page_next" />
                        <spring:url value="/post-event/post/fl/categories/${cateID}/page/${last}" var="last" />
                        <li id = "first" class="">
