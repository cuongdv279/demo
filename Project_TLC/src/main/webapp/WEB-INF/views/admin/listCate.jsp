                    ...
                    <div class="panel-body">
                        <div class="dataTable_wrapper">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <c:forEach var="listCateWithPage" items="${listCateWithPage }" varStatus="status">
                                    <tr class="odd gradeX">
                                        <td>${status.index + 1 }</td>
                                        <td><a href="#">${listCateWithPage.cateId}</a></td>
                                        <td>${listCateWithPage.cateName}</td>
                                        <td>${listCateWithPage.cateDesc}</td>
                                        <td>
                                            <a class="btn" href="<c:url value="/admin/cate/edit/${listCateWithPage.cateId}"/>" >Edit</a>
                                            <span>|</span>
