                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <c:forEach var="messageRecevierListSeen" items="${messageRecevierListSeen }" varStatus="status">
                                    <tr class="odd gradeX">
                                        ...
                                        <td><a href="<c:url value="/admin/profile/user/${messageRecevierListSeen.message_ID.fromUserID.user_ID}"/>">${messageRecevierListSeen.message_ID.fromUserID.first_Name}</a></td>
                                        <td>${messageRecevierListSeen.message_ID.subject}</td>
                                        <td>New Messages</td>
                                        <td>${messageRecevierListSeen.message_ID.dateSend}</td>
                                        <td>
                                            <a class='btn' href="<c:url value="/admin/detail-message/msg/${messageRecevierListSeen.message_ID.messageID}"/>" >
