                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="dataTable_wrapper">
                            <form action="<c:url value="/admin/all/allpost/create"/>" method="POST" role="form" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>Title Post<span style="color: red"> *</span></label>
                                    <input class="form-control" name="titlePost" type="text" required="true" >
                                </div>
                                <div class="form-group">
                                    <label>Categories<span style="color: red"> *</span></label>
                                    <select class="form-control" id="" name="categories" required="true">
                                ...
                                <%--<div class="form-group">--%>
                                    ...
                                    <%--<textarea class="form-control textarea ckeditor" rows="3" name="rules" id="content" placeholder="Content"></textarea>--%>
                                <%--</div>--%>
                                <div class="form-group">
                                    <label>Description<span style="color: red"> *</span></label>
                                    <textarea class="form-control textarea ckeditor" rows="3" name="description" id="content" placeholder="Content"></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Photo</label>
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="hidden" name="userID" value="${sessionUser.user_ID}">
                                </div>
