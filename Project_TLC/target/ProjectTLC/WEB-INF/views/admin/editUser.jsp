                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="dataTable_wrapper">
                            <form action="<c:url value="/admin/all/user/${user.user_ID}/edit"/>"  method="POST" role="form" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>User ID</label>
                                    <input class="form-control" type="text" disabled="true" value="${user.user_ID}">
                                </div>
                                <div class="form-group">
                                    <label>First Name</label>
                                    <input class="form-control" type="text" disabled="true" value="${user.first_Name}">
                                </div>
                                <div class="form-group">
                                    <label>Last Name</label>
                                    <input class="form-control" type="text" disabled="true" value="${user.last_Name}">
                                </div>
                                <div class="form-group">
                                    <label>Gender</label>
                                ...
                                <div class="form-group">
                                    <label>Address</label>
                                    <input class="form-control" type="text" disabled="true" value="${user.address}">
                                </div>
                                <div class="form-group">
                                    <label>Phone Number</label>
                                    <input class="form-control" type="text" disabled="true" value="${user.phone_Number}">
                                </div>
                                <div class="form-group">
                                    <label>Birthday</label>
                                    <input class="form-control" type="text" disabled="true" value="${user.birthday}">
                                </div>
                                <div class="form-group">
                                    <label>Job</label>
                                    <input class="form-control" type="text" disabled="true" value="${user.job}">
                                </div>
                                <div class="form-group">
                                    <label>Country </label>
                                    <input class="form-control" type="text" disabled="true" value="${user.country}">
                                </div>
                                <div class="form-group">
                                    <label>Website </label>
                                    <input class="form-control" type="text" disabled="true" value="${user.website}">
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
