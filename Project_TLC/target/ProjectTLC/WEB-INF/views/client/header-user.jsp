...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function()
        {
            ...
            $.ajax({
                ...
                url : '<c:url value="/getnotification" />',
                data : "userID="+userID,
                success : function(data) {
                    $('#notificationsBody').html(data);
                }
            });
            var rowCount = $('#notificationsBody').children().length;
            console.log(rowCount);
            $('#msg_count').html(rowCount);
            $("#msg_count").fadeIn("slow");
    ...
    <script type="text/javascript">
        var intervalId = 0;
        intervalId = setInterval(crunchifyAjax, 120000);
    </script>
            ...
            <ul class="nav navbar-nav navbar-right ">
                ...
                <li class="dropdown ">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <spring:url value="/post-user/post-topic" var="PostTopic"/>
                        <li class=""><a href="${PostTopic}">Danh sách các nhóm</a></li>
                        <li class="divider"></li>
                        <spring:url value="/post-user/create-topic" var="CreateTopic"/>
                        <li><a href="${CreateTopic}">Tạo nhóm</a></li>
                    </ul>
                </li>
                <li>
                    <spring:url value="/post-event/post" var="Localtion"/>
                    <a class="page-scroll" href="${Localtion}">Bài viết</a>
                </li>
                <li>
                    <a class="page-scroll" href="#"data-toggle="modal" data-target="#introModal">Giới thiệu</a>
                </li>
                <li>
                    <a class="page-scroll" href="#">Liên hệ</a>
                </li>
                <li id="notify_li">
                    <a href="#" id="notifylink"><i class="fa fa-bell-o"></i></a>
                    ...
                    <div id="notificationContainer">
                        ...
                        <div id="notificationFooter"><a href="#">Xem hết</a></div>
                    </div>
                ...
                <li class="dropdown ">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                        ...
                        <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <input id="userID" type="hidden" value="${sessionUser.user_ID}">
                        <li class=""><a href="<c:url value="/manage-user/${sessionUser.user_ID}"/>">Quản lý cá nhân</a></li>
                        <li class="divider"></li>
